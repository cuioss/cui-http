...
image:https://github.com/cuioss/cui-http/actions/workflows/benchmark.yml/badge.svg[JMH Benchmarks,link=https://github.com/cuioss/cui-http/actions/workflows/benchmark.yml]
image:https://img.shields.io/endpoint?url=https://cuioss.github.io/cui-http/benchmarks/badges/performance-badge.json[Performance Score,link=https://cuioss.github.io/cui-http/benchmarks/micro/]
...
./mvnw test                   # Run tests
./mvnw -Ppre-commit clean verify  # Auto-fixes headers + OpenRewrite recipes (MANDATORY; commit the diff)
./mvnw -Pcoverage clean verify    # Coverage report
----

NOTE: AI coding agents must not hard-code `./mvnw`/`mvn`; they invoke builds via the canonical
