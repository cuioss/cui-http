...
class UnicodePathTraversalAttackTest {
    ...
    void shouldRejectAllUnicodePathTraversalPatterns(String unicodeAttackPattern) {
        ...
        assertTrue(isUnicodePathTraversalSpecificFailure(exception.getFailureType()),
     ...
     */
    private boolean isUnicodePathTraversalSpecificFailure(UrlSecurityFailureType failureType) {
