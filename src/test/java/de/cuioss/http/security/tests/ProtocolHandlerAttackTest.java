...
class ProtocolHandlerAttackTest {
    ...
    void shouldRejectAllProtocolHandlerAttackPatterns(String protocolAttackPattern) {
        ...
        assertTrue(isProtocolHandlerSpecificFailure(exception.getFailureType()),
     ...
     */
    private boolean isProtocolHandlerSpecificFailure(UrlSecurityFailureType failureType) {
