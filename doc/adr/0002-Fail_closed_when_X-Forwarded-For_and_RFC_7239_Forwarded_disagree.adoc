...
Superseded by xref:0021-Unresolvable_Forwarded_header_suppresses_only_the_fields_it_carried.adoc[ADR-0021:
...
ADR-0021 also settles two questions this ADR did not reach — reconciling the two
...
* xref:0021-Unresolvable_Forwarded_header_suppresses_only_the_fields_it_carried.adoc[ADR-0021: Unresolvable Forwarded header suppresses only the fields it carried] — supersedes this ADR
