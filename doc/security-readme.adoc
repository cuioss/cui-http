...
=== xref:../src/main/java/de/cuioss/http/security/pipeline/HTTPBodyValidationPipeline.java[HTTPBodyValidationPipeline]

For full URLs with protocols, protocol handler injection.
