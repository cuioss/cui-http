...
Comprehensive testing framework for HTTP security validation with generator-based testing, attack databases, and performance validation.

For detailed generator implementation requirements, see link:generator-contract.adoc[Generator Contract Specification].
...
include::../../test-framework-structure.adoc[]
...
For generator implementation details, see link:generator-contract.adoc[Generator Contract Specification].

For usage as a test dependency, see link:../../test-generators-readme.adoc[Test Generators README].
