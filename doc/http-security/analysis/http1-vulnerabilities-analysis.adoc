...
4. **Test Coverage:** 553 tests total across the two generator-driven attack-test classes below
   ...
   * link:../../../cui-http-core/src/test/java/de/cuioss/http/security/tests/HttpRequestSmugglingAttackTest.java[HttpRequestSmugglingAttackTest] (395 tests)
   * link:../../../cui-http-core/src/test/java/de/cuioss/http/security/tests/HttpHeaderInjectionAttackTest.java[HttpHeaderInjectionAttackTest] (158 tests: 150 generated + 8 fixed)
...
* link:../../../cui-http-core/src/test/java/de/cuioss/http/security/tests/HttpRequestSmugglingAttackTest.java[HttpRequestSmugglingAttackTest] - generator-driven CL.TE/TE.CL/TE.TE/CL.CL and related smuggling patterns
* link:../../../cui-http-core/src/test/java/de/cuioss/http/security/tests/Http1VulnerabilitiesTest.java[Http1VulnerabilitiesTest] - focused regression cases for the specific HTTP/1.x parser-differential vectors analysed in this document
...
**Test Coverage (395 test cases — the HttpRequestSmugglingAttackTest subset of the 553 total):**
