...
Implemented in: link:../../../src/main/java/de/cuioss/http/security/pipeline/HTTPBodyValidationPipeline.java[HTTPBodyValidationPipeline]

* Full URL validation with protocols
* XSS and script injection detection
* JSON/XML content validation
* File upload filename validation

Body data structure: link:../../../src/main/java/de/cuioss/http/security/data/HTTPBody.java[HTTPBody]
