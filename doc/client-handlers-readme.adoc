...
==== link:../src/main/java/de/cuioss/http/client/ResilientHttpHandler.java[ResilientHttpHandler]
...
==== link:../src/main/java/de/cuioss/http/client/HttpHandlerProvider.java[HttpHandlerProvider]
...
==== link:../src/main/java/de/cuioss/http/client/converter/HttpContentConverter.java[HttpContentConverter]
...
==== link:../src/main/java/de/cuioss/http/client/converter/StringContentConverter.java[StringContentConverter]
...
==== link:../src/main/java/de/cuioss/http/client/result/HttpResultObject.java[HttpResultObject]
...
==== link:../src/main/java/de/cuioss/http/client/result/HttpErrorCategory.java[HttpErrorCategory]
...
==== link:../src/main/java/de/cuioss/http/client/result/HttpResultState.java[HttpResultState]

HTTP-specific result states extending CUI result framework.

=== Retry Strategies

==== link:../src/main/java/de/cuioss/http/client/retry/RetryStrategy.java[RetryStrategy]

Interface for HTTP retry strategies with built-in implementations.

* `RetryStrategy.none()` - No retry
* `RetryStrategy.exponentialBackoff()` - Exponential backoff with jitter
* `RetryStrategy.fixedDelay(duration)` - Fixed delay between attempts
* Configurable max attempts and delays

==== link:../src/main/java/de/cuioss/http/client/retry/ExponentialBackoffRetryStrategy.java[ExponentialBackoffRetryStrategy]
...
==== link:../src/main/java/de/cuioss/http/client/retry/RetryContext.java[RetryContext]
...
==== link:../src/main/java/de/cuioss/http/client/retry/RetryMetrics.java[RetryMetrics]
...
==== link:../src/main/java/de/cuioss/http/client/LoadingStatusProvider.java[LoadingStatusProvider]

Interface for components providing loading status.

==== link:../src/main/java/de/cuioss/http/client/LoaderStatus.java[LoaderStatus]
...
==== link:../src/main/java/de/cuioss/http/client/HttpLogMessages.java[HttpLogMessages]
...
RetryStrategy exponential = RetryStrategy.exponentialBackoff();
...
// Fixed delay
RetryStrategy fixed = RetryStrategy.fixedDelay(Duration.ofSeconds(2));
----
