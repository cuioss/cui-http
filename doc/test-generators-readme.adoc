...
Located in `src/test/java/de/cuioss/http/security/generators/`:

* **SupportedValidationTypeGenerator** - Generates ValidationTypes for PipelineFactory
* **body/** - HTTP body generators
* **cookie/** - Cookie structure generators
* **encoding/** - Encoding pattern generators
* **header/** - HTTP header generators
* **injection/** - Injection attack generators
* **url/** - URL component generators
