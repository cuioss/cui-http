        ...
        static Stream<Arguments> charsetPrecedenceCases() {
            return Stream.of(
                    ...
                    Arguments.of("The charset parameter name is matched case-insensitively",
                            StandardCharsets.UTF_8, "text/plain; Charset=ISO-8859-1", StandardCharsets.ISO_8859_1),
                    Arguments.of("Whitespace on both sides of the separator is tolerated: charset = X",
                            StandardCharsets.UTF_8, "text/plain; charset = ISO-8859-1", StandardCharsets.ISO_8859_1),
                    Arguments.of("Whitespace before the separator is tolerated: charset =X",
                            StandardCharsets.UTF_8, "text/plain; charset =ISO-8859-1", StandardCharsets.ISO_8859_1),
                    Arguments.of("Whitespace after the separator is tolerated: charset= X",
                            StandardCharsets.UTF_8, "text/plain; charset= ISO-8859-1", StandardCharsets.ISO_8859_1),
                    Arguments.of("A spaced separator still honours a quoted value",
                            StandardCharsets.UTF_8, "text/plain; charset = \"ISO-8859-1\"", StandardCharsets.ISO_8859_1),
                    Arguments.of("A parameter merely ENDING in charset is not the charset parameter",
                            StandardCharsets.ISO_8859_1, "text/plain; supercharset=UTF-8", StandardCharsets.ISO_8859_1),
                    Arguments.of("A parameter segment carrying no separator is skipped",
                            StandardCharsets.ISO_8859_1, "text/plain; flag", StandardCharsets.ISO_8859_1),
