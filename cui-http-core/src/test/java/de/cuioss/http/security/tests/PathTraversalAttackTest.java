 ...
 *   <li>Unicode traversal variants (U+2024 ONE DOT LEADER with U+FF0F FULLWIDTH SOLIDUS or
...
class PathTraversalAttackTest {
    ...
    void shouldRejectAllPathTraversalPatterns(String pathTraversalPattern) {
        ...
        assertTrue(isSpecificPathTraversalFailure(exception.getFailureType()),
     ...
     */
    private boolean isSpecificPathTraversalFailure(UrlSecurityFailureType failureType) {
